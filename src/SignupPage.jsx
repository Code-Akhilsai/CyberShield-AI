...
const SignupPage = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-linear-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center overflow-auto md:overflow-hidden">
      {" "}
